        ...
        <>
            ...
            <div className='CenterDetails'>
                <table>
                                ...
                                <tbody>
                                    {listaParcela.map((result:Parcela, index) =>(
                                        
                                        <tr>
                                            <td key={index}>{result.nomeCliente}</td>
                                            <td key={index}>{result.dataVencimento}</td>
                                            <td key={index}>{result.valorParcela}</td>
                                            <td key={index}>{result.valorPago}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                            ...
                            <table>
                                ...
                                <tbody>
                                    {listaParcela.map((result:Parcela, index) =>(
                                        ...
                                        <tr>
                                            <td key={index}>{result.idCliente}</td>
                                            <td key={index}>{result.dataVencimento}</td>
                                            <td key={index}>{result.valorParcela}</td>
                                            <td key={index}>{result.valorPago}</td>
                                        </tr>
